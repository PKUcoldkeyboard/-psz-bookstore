...
public class Post implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getPostId() == null ? other.getPostId() == null : this.getPostId().equals(other.getPostId()))
            ...
            && (this.getPostLikeNum() == null ? other.getPostLikeNum() == null : this.getPostLikeNum().equals(other.getPostLikeNum()))
            && (this.getPostCollectNum() == null ? other.getPostCollectNum() == null : this.getPostCollectNum().equals(other.getPostCollectNum()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPostLikeNum() == null) ? 0 : getPostLikeNum().hashCode());
        result = prime * result + ((getPostCollectNum() == null) ? 0 : getPostCollectNum().hashCode());
